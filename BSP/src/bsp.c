...
#define HSE_EXTERNAL_CRYSTAL_8MHZ	8u			//忽略MHZ单位
#define HSI_INTERNAL_RC_OSC_16MHZ	16u			//忽略MHZ单

#define SYS_CLK_120MHZ					120000000u
...
#define LEDn                            4                       /*神舟LED数量*/
#define GPIO_LED                        GPIOF                   /*神舟LED灯使用的GPIO组*/
