...
#define SPI_INT_TX				((uint16_t)0x0080)
#define SPI_INT_RX				((uint16_t)0x0040)
#define SPI_INT_ERR				((uint16_t)0x0020)
...
void SPI_IntCondfig(SPI_TypeDef* SPIx, uint8_t SPI_int);
