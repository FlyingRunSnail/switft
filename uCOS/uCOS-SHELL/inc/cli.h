 ...
 *           (If cmd is NULL or "" or longer than SHELL_SYS_CBSIZE-1 it is
 ...
 * maximum line length is SHELL_SYS_CBSIZE including a \0 terminator, which
 ...
 *
 * At most SHELL_SYS_MAXARGS arguments are permited - if there are more
 * than that then an error is printed, and this function returns
 * SHELL_SYS_MAXARGS, with argv[] set up to that point.
 *
