...
#define CMD_REGISTER_OK (0)
#define CMD_REGISTER_FAIL (-1)
...
#define SHELL_SYS_PBSIZE  (64)
#define SHELL_SYS_CBSIZE  (64)
#define SHELL_SYS_MAXARGS  (16)
#define SHELL_SYS_PROMPT  ("andisat #")
...
#define SHELL_CMD_REG(_name, _maxargs, _rep, _cmd, _usage, _help) \
	cmd_register(_name, _maxargs, _rep, _cmd, _usage, _help)
